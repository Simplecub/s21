...
START_TEST(sprintf_6_signed) {
  ...
  int val4 = -38;
  int val5 = -100;
  ck_assert_int_eq(sprintf(str1, str3, val, val, val2, val3, val4, val5),
                   s21_sprintf(str2, str3, val, val, val2, val3, val4, val5));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST
...
START_TEST(sprintf_12_signed) {
  char str1[200];
  char str2[200];
  char *str3 = "%+06d Test %+3.d Test %+5.7d TEST %+10d GOD %+.d";
  int val = 32;
  int val2 = -8899;
  int val3 = 91918;
  int val4 = -32311;
